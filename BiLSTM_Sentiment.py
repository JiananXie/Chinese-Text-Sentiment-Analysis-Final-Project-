...
from keras.layers import Dense, LSTM, Embedding,Masking, Bidirectional
...
lstm = LSTM(units=64,activation='softmax',dropout=0.2, input_shape=(max_length,1),return_sequences=False)
...
plt.ylabel('Truth')
plt.savefig('cm_BiLSTM_with_6.png')
...
plt.grid(True)
plt.savefig('roc_BiLSTM_with_6.png')
